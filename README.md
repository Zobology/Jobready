...
- Post-evaluation personalized coaching plans of 2, 4, 8, 16, or 24 hours, with configurable AI/expert ratios and separate one-hour expert scheduling preferences
- Mentor/admin approval of every 4+ hour AI self-paced and expert-session roadmap before it is shared with the candidate
- Server-side assessment autosave and resume, including durable audio/Excel evidence, plus saved progress for every AI self-paced coaching module
